    ...
    <Router>
      ...
      <div className="min-h-screen selection:bg-brand-gold selection:text-brand-dark">
        ...
        <a 
          ...
          className="fixed bottom-8 right-8 z-50 h-14 w-14 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 transition-transform focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#25D366] flex items-center justify-center"
        >
          <svg
